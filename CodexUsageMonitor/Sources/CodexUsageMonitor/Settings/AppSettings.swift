...
final class AppSettings: ObservableObject {
    ...
    @Published var thresholdWarningsEnabled: Bool { didSet { defaults.set(thresholdWarningsEnabled, forKey: Key.thresholdWarnings) } }
    ...
    init(defaults: UserDefaults = .standard) {
        ...
        thresholdWarningsEnabled = Self.value(for: Key.thresholdWarnings, defaults: defaults, defaultValue: true)
