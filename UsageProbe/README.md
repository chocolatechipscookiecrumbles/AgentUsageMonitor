...
Turning off **Enable quota notifications** greys every subordinate warning and quiet-hours control without erasing its stored value. Notification authorization status and **Open Notification Settings…** remain available so denied macOS permission can still be repaired.
