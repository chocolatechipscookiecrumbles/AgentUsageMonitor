...
- Claude-specific differences (no sign-in, no credits/reset-credits, weekly shared-pool footnote) render correctly; Claude's privacy data appears in **Data & Privacy**, not the Agents page.
